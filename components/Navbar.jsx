          ...
          <Container>
            <div className="flex items-center">
              <div className="w-3/12 lg:hidden">
                <button className="flex items-center" onClick={()=> setOffcanvas(!offcanvas)}>
              ...
              <div className={`lg:w-7/12 w-full fixed bg-gradient-to-b from-gray-600 to-gray-900 transition-all top-0 h-full p-10 lg:bg-none lg:static lg:p-0 lg:h-auto ${offcanvas ? "left-0" :"-left-full"}`}>
                <button className="absolute top-10 right-10 cursor-pointer lg:hidden" onClick={()=> setOffcanvas(!offcanvas)}>
              ...
              <div className={`lg:w-3/12 w-full absolute left-0 px-10 transition-all lg:static ${search ? "top-10" : "-top-40"}`}>
                <input className="bg-gray-700 py-3 px-6 w-full lg:rounded-full rounded-lg bg-search pl-12" placeholder="Search..."/>
                <button className="absolute top-3 right-12 cursor-pointer lg:hidden" onClick={()=> setSearch(false)}>
                  <svg  xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-x"><line x1="18" y1="6" x2="6" y2="18"></line><line x1="6" y1="6" x2="18" y2="18"></line>
                  </svg>
                </button>
              </div>
